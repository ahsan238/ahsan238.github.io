...
Promise.all([
    ...
    // results
    const as = document.createElement("pre")
    console.log('WebGLRenderingContext: ', md5(JSON.stringify(webgl)))
    console.log('WebGL2RenderingContext: ', md5(JSON.stringify(webgl2)))
    as.innerText = 'WebGLRenderingContext: ' + md5(JSON.stringify(webgl)) +"\n" + 'WebGL2RenderingContext: ' + md5(JSON.stringify(webgl2)) +"\n"
